...
```sh
version="v0.6.1" && wget -O - "https://github.com/DeveloperC286/is_affected/releases/download/${version}/x86_64-unknown-linux-musl.tar.gz" | tar xz --directory "/usr/bin/"
```
...
<!-- x-release-please-start-version -->
```sh
cargo install is_affected --version 0.6.1
```
<!-- x-release-please-end -->
